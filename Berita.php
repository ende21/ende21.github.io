  ...
  <style>
    ...
    * {
    ...
    .news-card.in-view {
      ...
      /* bayangan lebih jelas saat tampil */
    }
    ...
    <?php if (mysqli_num_rows($result) > 0): ?>
      <?php while ($row = mysqli_fetch_assoc($result)): ?>
        ...
        <div class="news-card reveal">
          <img src="<?= htmlspecialchars($thumbnail) ?>" alt="Thumbnail Berita" onerror="this.src='pict/default.png'">
