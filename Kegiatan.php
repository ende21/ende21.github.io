...
// Ambil data program dengan kategori 'pikk' dan status 'aktif'
$query = "SELECT * FROM programs WHERE kategori = 'pikk' AND status = 'aktif' ORDER BY tanggal DESC";
...
<body>
  ...
  <main>
    ...
    <?php if (mysqli_num_rows($result) > 0): ?>
      ...
      <?php endwhile; ?>
    <?php else: ?>
      <p style="text-align:center; color:#777;">Belum ada program PIKK yang tersedia.</p>
    <?php endif; ?>
  </main>
